package com.s.g.tecnologa.course.config;
...
import com.s.g.tecnologa.course.entities.Payment;
import com.s.g.tecnologa.course.entities.Product;
import com.s.g.tecnologa.course.entities.User;
import com.s.g.tecnologa.course.entities.enums.OrderStatus;
import com.s.g.tecnologa.course.repositories.CategoryRepository;
import com.s.g.tecnologa.course.repositories.OrderItemRepository;
...
import com.s.g.tecnologa.course.repositories.UserRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		p1.getCategories().add(cat2);//paradigima OO
		...
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));//paradiguima relacional
